...
public class NoScrollGridView extends GridView {
    ...
    private View.OnTouchListener topViewTouchListener = new View.OnTouchListener() {
    ...
    private View.OnTouchListener bottomViewTouchListener = new View.OnTouchListener() {
